...
function Settings() {
  ...
  return (
    ...
    <div className='p-6 bg-white border border-gray-200 rounded-lg shadow-xl mt-5'>
       <Logo/>
    </div>
    ...
    <div className='p-6 bg-white border border-gray-200 rounded-lg shadow-xl mt-5 cursor-pointer' onClick={()=>{navigate('/add-business')}}>
       <h2 className="text-2xl font-bold text-gray-800">Add Business</h2>
    </div>

    <div className="p-6 bg-white border border-gray-200 rounded-lg shadow-xl mt-5 cursor-pointer" onClick={()=>{navigate('/update-eway')}}>
